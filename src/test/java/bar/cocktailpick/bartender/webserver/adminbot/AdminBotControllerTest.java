...
@WebMvcTest(controllers = AdminBotController.class)
class AdminBotControllerTest {
    ...
    void service() throws Exception {
        given(adminBotService.serve(any())).willReturn(new AdminBotResponse("서기 -> 그니"));

        mockMvc.perform(post("/api/admin-bot")
